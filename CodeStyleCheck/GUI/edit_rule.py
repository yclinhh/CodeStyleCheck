...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("Form", "规则类型表信息"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_9), _translate("Form", "关键字表信息"))
